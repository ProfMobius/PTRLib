...
public final class MathUtils {
	...
	static public float sin (final float radians) {
		return Sin.table[(int)(radians * radToIndex) & SIN_MASK];
	}

	/** Returns the cosine in radians from a lookup table. */
	static public float cos (final float radians) {
		return Sin.table[(int)((radians + PI / 2) * radToIndex) & SIN_MASK];
	}

	/** Returns the sine in radians from a lookup table. */
	static public float sinDeg (final float degrees) {
		return Sin.table[(int)(degrees * degToIndex) & SIN_MASK];
	}

	/** Returns the cosine in radians from a lookup table. */
	static public float cosDeg (final float degrees) {
	...
	static public float atan2 (float y, float x) {
		...
		final float invDiv = 1 / ((x < y ? y : x) * INV_ATAN2_DIM_MINUS_1);
	...
	static public int random (final int range) {
		return random.nextInt(range + 1);
	}

	/** Returns a random number between start (inclusive) and end (inclusive). */
	static public int random (final int start, final int end) {
		return start + random.nextInt(end - start + 1);
	}

	/** Returns a random number between 0 (inclusive) and the specified value (inclusive). */
	static public long random (final long range) {
		return (long)(random.nextDouble() * range);
	}

	/** Returns a random number between start (inclusive) and end (inclusive). */
	static public long random (final long start, final long end) {
	...
	static public boolean randomBoolean (final float chance) {
	...
	static public float random (final float range) {
		return random.nextFloat() * range;
	}

	/** Returns a random number between start (inclusive) and end (exclusive). */
	static public float random (final float start, final float end) {
	...
	public static float randomTriangular (final float min, final float max, final float mode) {
		final float u = random.nextFloat();
	...
	static public long clamp (final long value, final long min, final long max) {
		if (value < min) return min;
		if (value > max) return max;
		return value;
	}
	...
	static public double clamp (final double value, final double min, final double max) {
		if (value < min) return min;
		if (value > max) return max;
		return value;
	}
	...
	static public float lerp (final float fromValue, final float toValue, final float progress) {
	...
	static public int floor (final float value) {
		return (int)(value + BIG_ENOUGH_FLOOR) - BIG_ENOUGH_INT;
	}

	/** Returns the largest integer less than or equal to the specified float. This method will only properly floor floats that are
	 * positive. Note this method simply casts the float to int. */
	static public int floorPositive (final float value) {
		return (int)value;
	}

	/** Returns the smallest integer greater than or equal to the specified float. This method will only properly ceil floats from
	 * -(2^14) to (Float.MAX_VALUE - 2^14). */
	static public int ceil (final float value) {
		return (int)(value + BIG_ENOUGH_CEIL) - BIG_ENOUGH_INT;
	}

	/** Returns the smallest integer greater than or equal to the specified float. This method will only properly ceil floats that
	 * are positive. */
	static public int ceilPositive (final float value) {
	...
	static public int roundPositive (final float value) {
	...
	static public float log (final float a, final float value) {
		return (float)(Math.log(value) / Math.log(a));
	}

	/** @return the logarithm of value with base 2 */
	static public float log2 (final float value) {
		return log(2, value);
	}
}
